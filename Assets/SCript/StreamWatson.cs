...
namespace IBM.Watsson.Examples
{
    ...
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        public Text stringToTestTone;//この文字列変数に文を入れる。ここに文章を入れると、その感情を読み取ってくれる。多分。
        ...
        {
            //入力確定後エンター時の関数
            Debug.Log("入力したのは「" + stringToTestTone.text + "」だよ");
